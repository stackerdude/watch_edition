Code coverage is automatically reported by _jest_, our unit testing framework; a small summary table will be output to the terminal each time we run tests. 
